...
// Option 配置函数
type Option func(*RepoGorm)

// UserName 用户名配置
func UserName(userName string) Option {
	return func(RepoGorm *RepoGorm) {
		RepoGorm.userName = userName
	}
}

func LogMode(mode bool) Option {
	return func(RepoGorm *RepoGorm) {
		RepoGorm.logMode = mode
	}
}
...
/*func NewFromConfigFile(file *config.Config, fn *FieldName) *RepoGorm {
...
// ReadAll 查询单条
func (repo *RepoGorm) ReadAll(out interface{}, where ...interface{}) (e error) {
	defer func() {
...
func (repo *RepoGorm) ReadAllWithOrderBy(out interface{}, orderby interface{}, where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Read 查询单条记录
func (repo *RepoGorm) Read(out interface{}, where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Read 查询单条记录
func (repo *RepoGorm) ReadWithOrderBy(out interface{}, orderby interface{}, where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
func (repo *RepoGorm) Exist(out interface{}, where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Remove 删除
func (repo *RepoGorm) Remove(val interface{}, where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Remove 获取影响行数
func (repo *RepoGorm) RemoveWithAffect(val interface{}, where ...interface{}) (affects int64, e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Insert 新增
func (repo *RepoGorm) Insert(val interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
func (repo *RepoGorm) SoftRemove(value interface{}, where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Modify 修改
func (repo *RepoGorm) Modify(val interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// 更改单个字段
func (repo *RepoGorm) ModifyColumn(val interface{}, attr string, upValue interface{}, where ...interface{}) (affects int64, e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// 更改多个字段
func (repo *RepoGorm) ModifyColumns(val interface{}, columns interface{}, where ...interface{}) (affects int64, e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// ModifyFunc 使用函数更新
func (repo *RepoGorm) ModifyFunc(val interface{}, modifier func(interface{}), where ...interface{}) (e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
// Transaction 执行包装事务
func (repo *RepoGorm) Transaction(f func(*RepoGorm) error) (e error) {
	repoTx := repo.begin()
...
// begin 开始一个事务
func (repo *RepoGorm) begin() *RepoGorm {
	//开始一个事务
	tx := repo.DB.Begin()
...
// Query 查询列表（可分页）
func (repo *RepoGorm) Query(out interface{}, count bool, exps ...Expression) (c int, e error) {
	defer func() {
		if err := recover(); err != nil {
			e = fmt.Errorf("%v", err)
		}
...
func (repo *RepoGorm) Print(args ...interface{}) {
	gorm.LogFormatter()
...
func (repo *RepoGorm) Migrate(initial func(*RepoGorm), values ...interface{}) {
